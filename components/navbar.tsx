...
export default function Navbar() {
    return (
        <div className='border-b py-3 px-3 fixed bg-white w-full z-50 mb-40'>
                ...
                <Popover>
                    <div className="relative">
                        <div className="flex flex items-center justify-between">
                            ...
                            <div className="rounded-md shadow bg-gree-600">
                                <Link
                                    href="/contact-us"
                                    className="flex hidden md:block w-full items-center justify-center rounded-md border border-transparent bg-blue-600 px-8 py-3 text-base font-medium text-white hover:bg-blue-700 md:py-2 md:px-10 md:text-lg"
