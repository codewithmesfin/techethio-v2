                ...
                >
                    <div className="p-2">
                        <div className="flex items-center spac-y-10 md:space-x-3">
                            <Image className="rounded-full p-2 w-[150px] h-[150px]" width={150} height={150} src={x.img} alt={x.name} />
                            <div>
                                <h1 className={`text-2xl font-bold`}>{x.name} </h1>
                                <h1 className={`text-md py-1 text-green-600 font-bold`}>{x.role} </h1>
