                ...
                teams.map((x: any, i: number) => <div  data-aos="zoom-in-up" data-aos-duration="3000" key={i} className={`mb-16 shadow rounded bg-${x.bg}`}>
                    <div className="p-2">
                        <div className="flex items-center spac-y-10">
                            ...
                            <div>
                                <h1 className={`text-${x.color} text-2xl font-bold`}>{x.name} </h1>
                                <h1 className={`text-md py-2  font-bold`}>{x.role} </h1>
                                <p className={`text-${x.color} text-xs`}>{x.bio} </p>
                                <div className="flex border-t mt-2  pt-2 space-x-2 md:space-x-20">
                                    <Link className={`text-${x.color}`} href={x.linkedin}>Linkedin </Link>
                                    <Link className={`text-${x.color}`} href={x.github}>Github </Link>
                                </div>
                            </div>
                        </div>
                    </div>
