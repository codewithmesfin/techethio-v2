                    ...
                    <div className="flex flex-wrap flex-row -mx-4 lightgallery-thumbnail" >
                        {
                          portfolios.map((x:any,i:number) => {
                                return (
                                    <figure  data-aos="zoom-in-up" data-aos-duration="3000" x-show="tab === 'graphic' || tab === 'photo' || tab === 'all'" data-src="/assets/imgs/placeholders/mobile.jpg" className="flex-shrink max-w-full px-4 w-full md:w-1/2 sm:w-1/2  lg:w-1/2 group" key={i} data-sub-html="title images">
